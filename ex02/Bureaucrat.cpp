...
/*   Updated: 2024/01/06 09:25:29 by rficht           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::execForm(const AForm& form) const
{
	if (this->_grade <=  form.getGradeExec())
		std::cout << this->_name << " executed " << form.getName() << "." << std::endl; 
	else
		std::cout << this->_name << " couldn't execute " << form.getName() << " its grade is too low." << std::endl; 		
}
